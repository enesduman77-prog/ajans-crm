...
function BigMetricCard({ label, value, icon: Icon, color, bgColor, sub, trend }: {
    ...
    return (
        <motion.div
            ...
            className="bg-[#111113] border border-white/[0.06] rounded-2xl p-5 hover:border-white/[0.1] transition-colors"
        >
    ...
    if (error || !status?.connected || !data || data.errorMessage) {
        return (
            <div className="space-y-6">
                ...
                <div className="bg-[#111113] border border-red-500/20 rounded-2xl p-8 flex flex-col items-center gap-4 text-center">
                    ...
                    <button onClick={() => navigate('/client/analytics')}
                        className="bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-medium px-5 py-2.5 rounded-xl transition-colors">
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    <button onClick={() => navigate('/client/analytics')}
                        className="h-10 w-10 rounded-xl bg-[#111113] border border-white/[0.06] flex items-center justify-center text-zinc-400 hover:text-white hover:border-white/[0.12] transition-all">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                    <div className="flex items-center gap-1.5 bg-emerald-500/10 border border-emerald-500/20 rounded-full px-3 py-1.5">
                        ...
                        <span className="text-[11px] text-emerald-400 font-medium">Bağlı</span>
                    </div>
                    {/* Tarih aralığı seçici */}
                    <div className="relative">
                        <button
                            onClick={() => setShowDateMenu(v => !v)}
                            className="flex items-center gap-1.5 bg-[#111113] border border-white/[0.06] hover:border-white/[0.12] rounded-full px-3 py-1.5 transition-colors"
                        >
                                        ...
                                        <div className="px-2 space-y-2 mt-1">
                                            <div>
                                                ...
                                                <input type="date" value={customStart}
                                                    ...
                                                    className="w-full bg-[#111113] border border-white/[0.08] rounded-lg px-2 py-1.5 text-xs text-white focus:outline-none focus:border-emerald-500/50" />
                                            </div>
                                            <div>
                                            ...
                                            <button
                                                ...
                                                className="w-full bg-emerald-600 hover:bg-emerald-500 disabled:opacity-40 text-white text-xs font-medium py-1.5 rounded-lg transition-colors"
                                            >
                                                Uygula
                                            </button>
                                        </div>
                    ...
                    <button
                        onClick={() => load(true)}
                        disabled={refreshing}
                        className="h-8 w-8 rounded-lg bg-[#111113] border border-white/[0.06] flex items-center justify-center text-zinc-400 hover:text-white hover:border-white/[0.12] transition-all disabled:opacity-50"
            ...
            {/* ANA METRİKLER */}
            <section>
                <SectionHeader icon={Zap} title="Genel Bakış" color="bg-emerald-500/20">
            ...
            {/* GÜNLÜK TREND */}
            <section>
                <SectionHeader icon={TrendingUp} title="Günlük Tıklama & Gösterim Trendi" color="bg-emerald-500/20" />
            ...
            <section className="bg-emerald-500/5 border border-emerald-500/10 rounded-2xl p-6">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        <h3 className="text-sm font-semibold text-emerald-300">Performans Özeti</h3>
                        <p className="text-xs text-zinc-500 mt-1">
                            ...
                            {data.topQueries.length > 0 && (
                                <> En çok tıklanan sorgu: <strong className="text-emerald-400">"{data.topQueries[0].query}"</strong>.</>
                            )}
                        </p>
                    </div>
                </div>
