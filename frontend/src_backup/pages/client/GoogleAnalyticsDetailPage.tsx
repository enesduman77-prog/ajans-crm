...
export default function GoogleAnalyticsDetailPage() {
    ...
    return (
        <div className="space-y-6">
                                        ...
                                        <div className="px-2 space-y-2 mt-1">
                                            <div>
                                                ...
                                                <input type="date" value={customStart}
                                                    ...
                                                    className="w-full bg-[#111113] border border-white/[0.08] rounded-lg px-2 py-1.5 text-xs text-white focus:outline-none focus:border-blue-500/50" />
                                            </div>
                                            <div>
            ...
            {/* ═══ ÖZET RAPOR ═══ */}
            <section>
                <SectionHeader icon={BarChart3} title="Performans Özeti" color="bg-emerald-500/20" />
