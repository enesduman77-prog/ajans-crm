            ...
            <div className="space-y-6">
                ...
                <div className="relative">
                    ...
                    <input type="text" value={search} onChange={e => setSearch(e.target.value)}
                        ...
                        className="w-full pl-10 pr-4 py-2.5 bg-[#111113] border border-white/[0.06] rounded-xl text-sm text-white placeholder:text-zinc-600 focus:outline-none focus:border-orange-500/30" />
                </div>
                    ...
                    {filteredCompanies.map(company => {
                        ...
                        return (
                            <button key={company.id}
                                ...
                                className="text-left bg-[#111113] border border-white/[0.06] rounded-xl p-4 hover:border-orange-500/20 hover:bg-[#131315] transition-all group">
