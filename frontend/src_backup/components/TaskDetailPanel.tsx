                        ...
                        <div className="sticky top-0 bg-[#0c0c0e]/95 backdrop-blur-sm border-b border-white/[0.06] p-5 z-10">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className={`text-[9px] px-2 py-0.5 rounded-md font-bold uppercase ${(priorityBadge[task.priority] || priorityBadge.MEDIUM).bg} ${(priorityBadge[task.priority] || priorityBadge.MEDIUM).text}`}>
                                        {(priorityBadge[task.priority] || priorityBadge.MEDIUM).label}
                                    </span>
                                </div>
                            ...
                            {task.status !== 'DONE' && onStatusChange && (
                                <button
                                    ...
                                    disabled={completing}
                                    className="mt-3 w-full flex items-center justify-center gap-2 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-sm font-bold transition-colors disabled:opacity-50"
                                >
