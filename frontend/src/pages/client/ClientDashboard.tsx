...
const mockStats = [
    ...
    { label: 'Sayfa Görüntüleme', value: '48,392', change: '+8.3%', icon: Eye, color: 'text-emerald-400 bg-emerald-500/10' },
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {mockStats.map((stat) => (
                    <div key={stat.label} className="bg-[#111113] border border-white/[0.06] rounded-2xl p-5">
